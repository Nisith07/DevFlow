    ...
    <footer className="lp-footer">
      <div className="lp-wrap">
        <div className="lp-footer-grid">
          ...
          <div className="lp-footer-brand-col">
            ...
            <p className="lp-footer-desc">
              Unifying code commits, task management, and standup automation into one luxurious flow. Built for creators.
            </p>
        ...
        <div className="lp-footer-bottom">
          <span>
            © {new Date().getFullYear()} DevFlow Technologies Inc. All rights reserved.
          </span>
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: '11px', letterSpacing: '0.05em' }}>
            designed by startup team
          </span>
        </div>
      </div>
    </footer>
